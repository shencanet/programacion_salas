...
<div class="container-fluid p-2">
    <form action="" id="edit_sched">
        ...
        <div class="form-group">
            <label for="assembly_hall_id" class="control-label">ALUMNO</label>
        ...
        <div class="form-group">
            <label for="datetime_start" class="control-label">ENTRADA:</label>
        ...
        <div class="form-group">
            <label for="datetime_end" class="control-label">SALIDA:</label>
