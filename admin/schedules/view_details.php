...
<div class="container-fluid p-2">
    <p><b>ALUMNO:</b> <?php echo $room_name ?></p>
    <p><b>ASIGNATURA:</b> <?php echo ucwords($reserved_by) ?></p>
    <p><b>ENTRADA</b> <?php echo date("M d, Y h:i",strtotime($datetime_start)) ?></p>
    <p><b>SALIDA:</b> <?php echo date("M d, Y h:i",strtotime($datetime_end)) ?></p>
