					...
					<div class="callout border-0">
						...
						<form action="" id="add_sched">
							...
							<div class="form-group">
								<label for="assembly_hall_id" class="control-label">Seleccionar Alumno</label>
							...
							<div class="form-group">
								<label for="reserved_by" class="control-label">Asignatura:</label>
								<select name="reserved_by">
									<option name="reserved_by" id="reserved_by">Ingles</option>
									<option name="reserved_by" id="reserved_by">Mates</option>
									<option name="reserved_by" id="reserved_by">Lectura</option>
									<option name="reserved_by" id="reserved_by">Presencial Online</option>
									<option name="reserved_by" id="reserved_by">Online</option>
								</select>
							...
							<div class="form-group">
								...
								SELECT DAYOFWEEK(datetime_start);
								</div>
							<div class="form-group">
...
<script>
	...
	$(function(){
		...
		$('.select2').select2({placeholder:"Porfavor selecciona un Alumno"})
