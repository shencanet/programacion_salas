...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Actualizar ": "Crear Nuevo " ?> Alumno</h3>
	</div>
	<div class="card-body">
		<form action="" id="assembly-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="room_name" class="control-label">Nombre del Alumno</label>
                <input name="room_name" id="" class="form-control form no-resize" value="<?php echo isset($room_name) ? $room_name : ''; ?>" />
			</div>
			<div class="form-group">
				<label for="location" class="control-label">Comentarios</label>
                <textarea name="location" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($location) ? $location : ''; ?></textarea>
			</div>
			<div class="form-group">
				<label for="description" class="control-label">Descripción Atencion Especial</label>
